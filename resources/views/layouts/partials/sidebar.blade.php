<aside class="aside aside-fixed">
    ...
    <div class="aside-body">
        ...
        <ul class="nav nav-aside">
            ...
            @company
            <li class="nav-item"><a href="{{route('module.companySettings.home')}}" class="nav-link"><i
            ...
            <li class="nav-item"><a href="tel:+923171015636" class="nav-link"><i data-feather="phone-call"></i> <span>+92 317 1015636</span></a>
            </li>
