...
@section('content')
    ...
    <div class="card card-body">
        <div style="display: flex" class="mb-3">
            <div style="flex: 1">
                <h4 id="section1" class="mg-b-10">Edit Customers</h4>
            </div>
            <div>
        ...
        <form action="{{route('module.'.$moduleName.'.update')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-1 mt-md-3" id="image-box" >
                   ...
                   @php $deleteFun = "deleteFile(".$data["id"].",'".route('module.suppliers.deleteFile',[$data["id"],'image'])."','".csrf_token()."','".$data['image']."')" @endphp
