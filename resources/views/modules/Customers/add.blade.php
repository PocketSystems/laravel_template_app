...
@section('content')
    ...
    <div class="card card-body">
        <div style="display: flex" class="mb-3">
            <div style="flex: 1">
                <h4 id="section1" class="mg-b-10">Add Customers</h4>
            </div>
            <div>
        ...
        <form action="{{route('module.'.$moduleName.'.create')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-row">
                <div class="form-group col-md-8">
                    ...
                    <input type="text" name="name"  required class="form-control @error('name') is-invalid @enderror" id="inputEmail4" placeholder="Please enter customer name">
                ...
                <div class="form-group col-md-4">
                    <label for="inputEmail4">Customer Image</label>
